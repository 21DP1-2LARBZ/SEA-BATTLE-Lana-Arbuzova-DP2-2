...
void Avake() //функция которая будет показана игроку самая первая
{
	...
	cout << "SEA BATTLE"; //выводим надпись на экран
}
void CreatField(int speed, int X, int num_color) //Функция благодоря которой будет отрисовываться игровое поле
{
	...
	char mas[10] = { 'A','B','C','D','E','F','G','H','I','J' }; //буковки которые будут находится сверху игрового поля и ориентировать игрока куда он бьёт
...
void Meny(int num)
{
	char variant[11][40] = { "THE ENEMY THINKS WHERE TO HIT ...","THE ENEMY MISSED!", "THE ENEMY HAPPENED!", "THE ENEMY WIN... DO NOT BE SAD...", "YOUR MOVE." , "YOU MISSED...", "YOU ARE IN TROUBLE!", "YOU WIN, CONGRATULATIONS!", "+++++++++++++++++++++++++++++++++++++++", "YOU GOT, GO AGAIN!", "WOOHOO, YOU DESTROYED THE ENEMY SHIP!" };
...
int main() //Функция из которой буду вызываться другие и осуществляться инициализация переменых и расстановка корабликов
{
	...
	char variant[2][30] = { "AUTOMATIC SPACING","MANUAL SPACATION" };
